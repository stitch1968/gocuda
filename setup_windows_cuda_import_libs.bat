...
REM Usage:
REM   setup_windows_cuda_import_libs.bat <cudart_dll> <cudnn_dll> [nvjpeg_dll] [nvjpeg2k_dll] [cudss_dll] [amgx_dll] [cutensor_dll] [cuda_driver_dll]
REM Example:
...
echo Current Windows native backends may require generated import libraries such as libcudnn.a, libnvjpeg.a, libnvjpeg2k.a, libcudss.a, libamgxsh.a, and libcutensor.a before CUDA-tagged builds can link successfully.
exit /b 0

:usage
echo Usage: %~n0 ^<cudart_dll^> ^<cudnn_dll^> [nvjpeg_dll] [nvjpeg2k_dll] [cudss_dll] [amgx_dll] [cutensor_dll] [cuda_driver_dll]
echo Example:
