...
- Native cuDNN, nvJPEG, nvJPEG2000, CUTLASS GEMM, cuDSS, AmgX, and cuTENSOR execution are wired for CUDA-tagged builds; Windows requires generated `lib_mingw\libcudnn.a`, `lib_mingw\libnvjpeg.a`, `lib_mingw\libnvjpeg2k.a`, `lib_mingw\libcublas.a`, `lib_mingw\libcudss.a`, `lib_mingw\libamgxsh.a`, and `lib_mingw\libcutensor.a` before those native paths can link
